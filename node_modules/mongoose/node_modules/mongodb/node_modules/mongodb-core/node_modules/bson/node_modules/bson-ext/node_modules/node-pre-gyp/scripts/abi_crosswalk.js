...
var template = 'https://raw.githubusercontent.com/joyent/node/v{VERSION}/server/';
var v8template = 'https://raw.githubusercontent.com/joyent/node/v{VERSION}/deps/v8/server/version.cc';
...
function get(ver,callback) {
  ...
  if (semver.gt(ver, 'v0.11.4')) {
    // https://github.com/joyent/node/commit/44ed42bd971d58b294222d983cfe2908e021fb5d#server/node_version.h
  ...
  https.get(uri, function(res) {
      ...
      res.on('end',function(err) {
        ...
        if (int_val !== undefined) {
          ...
          // https://github.com/joyent/node/blob/master/deps/v8/server/version.cc
